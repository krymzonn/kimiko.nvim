...
local groups = {
  ...
  bufferline = {
    ...
    BufferLineBufferVisible     = { fg = p.fg2, bg = p.bg3 },
    BufferLineTab               = { fg = p.fg_dim, bg = p.bg3 },
    BufferLineTabSelected       = { fg = p.active, bg = p.bg2 },
    BufferLineSeparator         = { fg = p.ui_border, bg = p.bg3 },
    BufferLineSeparatorSelected = { fg = p.ui_border, bg = p.bg2 },
    BufferLineModified          = { fg = p.warn, bg = p.bg_chg },
    BufferLineModifiedSelected  = { fg = p.active, bg = p.bg_chg },
    BufferLineDuplicate         = { fg = p.fg_dim, bg = p.bg3, italic = true },
    BufferLineIndicatorSelected = { fg = p.succ, bg = p.bg2 },
    BufferLineCloseButton       = { fg = p.err, bg = p.bg3 },
  },
  plugins = {

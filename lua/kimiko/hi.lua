...
local groups = {
  ...
  plugins = {
    ...
    -- Extend: NeoTreeDirectoryIcon = { fg = p.succ },
  },
  links = {
...
-- Bold groups (from gui)
local bold_groups = {
  "Conditional", "Define", "Exception", "Identifier", "Include",
  "Operator", "PreProc", "Repeat", "Statement", "StatusLineNC",
  "VertSplit", "WinSeparator", "htmlH1", "htmlH2", "htmlH5",
  "pythonBuiltin", "pythonStatement",
}
local bold_underline_groups = {
  "Function", "TabLine", "TabLineFill", "TabLineSel", "Title",
  "Todo", "htmlH3", "htmlH4",
}

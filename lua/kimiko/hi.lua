...
local groups = {
  base = {
    Normal       = { fg = p.fg1 },
    LineNr       = { fg = p.line },
    CursorLineNr = { fg = p.ui_status, bold = true },
  ...
  ui = {
    ...
    WinBar       = { fg = p.fg_dim, bg = p.bg_ui },
    WinBarNC     = { fg = p.fg_dim, bg = p.bg_ui },
    htmlH1       = { fg = p.title },
    htmlH2       = { fg = p.fg_h2 },
    htmlH3       = { fg = p.fg2 },
    htmlH4       = { fg = p.fg3 },
  ...
  bufferline = {
    ...
    BufferLineBufferSelected    = { fg = p.ui_status, bg = p.bg_tabs, bold = true },
    BufferLineBufferVisible     = { fg = p.fg2, bg = p.bg_ui },
    BufferLineTab               = { fg = p.fg_dim, bg = p.bg_ui },
    BufferLineTabSelected       = { fg = p.ui_status, bg = p.bg_tabs, bold = true },
    BufferLineSeparator         = { fg = p.ui_border, bg = p.bg_ui },
    BufferLineSeparatorSelected = { fg = p.ui_border, bg = p.bg_tabs },
    BufferLineModified          = { fg = p.warn, bg = p.bg_ui },
    BufferLineModifiedSelected  = { fg = p.warn, bg = p.bg_tabs },
    BufferLineDuplicate         = { fg = p.fg_dim, bg = p.bg_ui, italic = true },
    BufferLineIndicatorSelected = { fg = p.succ, bg = p.bg_tabs },
    BufferLineCloseButton       = { fg = p.err, bg = p.bg_ui },
  },
  plugins = {

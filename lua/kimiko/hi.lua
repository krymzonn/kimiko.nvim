...
local groups = {
  ...
  bufferline = {
    ...
    BufferLineBufferSelected      = { fg = p.active, bg = p.bg2, bold = true },
    BufferLineBufferVisible       = { fg = p.fg_dim, bg = p.bg2 },
    BufferLineTab                 = { fg = p.fg_dim, bg = p.bg2 },
    BufferLineTabSelected         = { fg = p.active, bg = p.bg2, bold = true },
    BufferLineTabClose            = { fg = p.err, bg = p.bg2 },
    ...
    BufferLineDuplicate           = { fg = p.fg_dim, bg = p.bg2, italic = true },
    BufferLineDuplicateSelected   = { fg = p.fg_dim, bg = p.bg2, italic = true },
    BufferLineIndicatorSelected   = { fg = p.succ, bg = p.bg2 },
    BufferLineCloseButton         = { fg = p.err, bg = p.bg2 },
    ...
    BufferLinePickSelected        = { fg = p.fg0, bg = p.bg2, bold = true },
